...
export const liveChannels: Channel[] = [
  { name: '@GhostAlpha', game: 'COD Mobile', viewers: 1200, avatarColor: '#3B82F6', initials: 'GA', isLive: true, streamTitle: 'CODM Lagos Qualifiers — Season 1 Alpha' },
  ...
  { name: '@KelechiFC', game: 'EA FC', viewers: 388, avatarColor: '#3B82F6', initials: 'KF', isLive: true, streamTitle: 'EA FC Street League — 1v1 Ranked' },
