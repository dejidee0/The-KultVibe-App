...
export const liveChannels: Channel[] = [
  { name: '@GhostAlpha', game: 'COD Mobile', viewers: 1200, avatarColor: '#10B981', initials: 'GA', isLive: true, streamTitle: 'CODM Lagos Qualifiers — Season 1 Alpha' },
  ...
  { name: '@KelechiFC', game: 'EA FC', viewers: 388, avatarColor: '#10B981', initials: 'KF', isLive: true, streamTitle: 'EA FC Street League — 1v1 Ranked' },
  { name: '@DrumKingKano', game: 'Music · Afrobeats', viewers: 309, avatarColor: '#F97316', initials: 'DK', isLive: true, streamTitle: 'Afrobeats Production Session — New EP Beats' },
