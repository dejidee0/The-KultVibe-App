  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ boxShadow: 'inset 0 0 0 1.5px rgba(16,185,129,0.50)' }}
      />
    </div>
  );
}
        ...
        <div className="flex-1 flex items-center justify-end gap-3">
          ...
          >
            <button
              ...
              style={{
                color: view === 'grid' ? '#10B981' : 'rgba(255,255,255,0.28)',
                background: view === 'grid' ? 'rgba(16,185,129,0.14)' : 'transparent',
              }}
              title="Grid view"
            >
            ...
            <button
              ...
              className="p-1.5 rounded-md transition-all duration-150"
              style={{
                color: view === 'list' ? '#10B981' : 'rgba(255,255,255,0.28)',
                background: view === 'list' ? 'rgba(16,185,129,0.14)' : 'transparent',
              }}
              title="List view"
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor">
        ...
        >
          ...
          {isLoadingMore && (
            <div className="flex items-center justify-center py-4">
              <div
                className="w-4 h-4 rounded-full border-2 border-white/10 border-t-emerald-500 animate-spin"
              />
            </div>
          )}
          {hasMore && <div ref={sentinelRef} className="h-1" />}
